...
export default function Footer() {
  return (
    <footer id="location" className="bg-[#F9F6F0] text-[#3B2B20] pt-24 px-4 overflow-hidden">
      ...
      {/* Stay Connected Card */}
      <div className="max-w-5xl mx-auto bg-[#a69b8d] rounded-[3rem] p-6 sm:p-12 md:p-20 text-center mb-24 shadow-sm w-full box-border">
        <h2 className="text-4xl md:text-6xl font-serif text-[#F9F6F0] font-bold mb-8">Stay Connected</h2>
        <div className="max-w-md mx-auto w-full flex flex-col sm:flex-row gap-3 sm:gap-2 bg-transparent sm:bg-[#F9F6F0]/20 sm:p-2 rounded-full sm:backdrop-blur-sm sm:border sm:border-[#F9F6F0]/30">
          <input
            type="email"
            placeholder="Enter your email..."
            className="w-full sm:flex-grow bg-[#F9F6F0]/20 sm:bg-transparent px-6 py-4 sm:py-3 text-[#F9F6F0] placeholder-[#F9F6F0]/70 outline-none rounded-full border border-[#F9F6F0]/30 sm:border-none min-w-0 box-border"
          />
          <button className="w-full sm:w-auto bg-[#3B2B20] text-[#F9F6F0] px-8 py-4 sm:py-3 rounded-full font-bold hover:bg-[#3B2B20]/80 transition-colors flex-shrink-0 box-border">
            Subscribe
          </button>
        </div>
      </div>
